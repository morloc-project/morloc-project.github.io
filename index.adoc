...
Morloc may be viewed as a query language that takes a program specification and
searches against a function database, returning an optimized composition of
functions. The functions may be selected all from one language or from several.
